...
describe 'Test Members Handling' do
  ...
  before do
    ...
    @account = Tripbook::Account.create(@account_data)
    @another_account = Tripbook::Account.create(@another_account_data)
    @wrong_account = Tripbook::Account.create(@wrong_account_data)
